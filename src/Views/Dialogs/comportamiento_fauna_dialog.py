...
Fecha:      12/03/2026
Comentarios:
    Módulo que contiene el diálogo de la entidad COMPORTAMIENTO DE FAUNA.
"""
...
from Views.Forms.comportamiento_fauna_form import ComportamientoFaunaForm


class ComportamientoFaunaDialog(BaseDialog):
    """ Diálogo de comportamiento de fauna. """
...
if __name__ == "__main__":
    ...
    ventana = ComportamientoFaunaDialog("...::OOO::....")
