...
Fecha:      19/12/2025
Comentarios:
    Módulo que contiene el diálogo de la entidad TIPO DE ILUMINACIÓN.
"""
...
from Views.Forms.tipo_iluminacion_form import TipoIluminacionForm


class TipoIluminacionDialog(BaseDialog):
    """ Diálogo de tipo de iluminación. """
    ...
    def __init__(self, w_title: str):
        ...
        self.frame = TipoIluminacionForm()
    ...
    def set_tab_order(self):
        ...
        self.frame.edit_tipo_iluminacion.setFocusPolicy(
            Qt.FocusPolicy.StrongFocus)
        self.frame.text_descripcion.setFocusPolicy(Qt.FocusPolicy.StrongFocus)

        # Establecer el orden
        self.setTabOrder(self.frame.edit_tipo_iluminacion,
...
if __name__ == "__main__":
    ...
    ventana = TipoIluminacionDialog("...::OOO::....")
