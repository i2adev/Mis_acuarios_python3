...
class RequerimientoIluminacionForm(QFrame):
    """
    ...
    def create_widgets(self):
        ...
        self.label_requerimiento = QLabel("REQUERIMIENTO ILUMINACIÓN")
        ...
        self.edit_requerimiento = StrLineEdit(
            control_name="REQUERIMIENTO ILUMINACIÓN",
            max_length=32,
        )
...
if __name__ == "__main__":
    ...
    ventana = RequerimientoIluminacionForm()
    ventana.show()
