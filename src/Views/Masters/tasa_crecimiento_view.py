...
from Views.Forms.tasa_crecimiento_form import TasaCrecimientoForm
from Views.Masters.base_view import BaseView


class TasaCrecimientoView(BaseView):
    """
    Formulario maestro de la TASA DE CRECIMIENTO.
    """
...
if __name__ == "__main__":
    ...
    ventana = TasaCrecimientoView("...::OOO::....")
