...
Fecha:  12/03/2026
Comentarios:
    Controlador base del comportamiento de fauna.
"""
...
from Services.Validators.comportamiento_fauna_validator import \
    ComportamientoFaunaValidator
...
class ComportamientoFaunaController(BaseController):
    ...
    def __init__(self,
                 ...
                 model: ComportamientoFaunaEntity):
        """
        Inicializa el controlador de comportamiento de fauna.
        :param view: ComportamientoFaunaDialog | ComportamientoFaunaView
        :param dao: ComportamientoFaunaDAO
        :param model: ComportamientoFaunaEntity
        """

        # Atributos
        self._comportamiento_result = None

        # Llamaos al constructor de la superclase
        super().__init__(view, dao, model)

    def _entity_configuration(self) -> ComportamientoFaunaEntity:
    ...
    def _validate_view(self) -> Result:
        ...
        val = ComportamientoFaunaValidator.validate_comportamiento(
    ...
    def _get_comportamiento(self):
        """ Devuelve la categoría de filtro resultante. """

        return self._comportamiento_result
    ...
    def _load_record(self) -> Result:
        ...
        comportamiento = modelo.index(fila, 2).data()  # La columna 1 es el
        # númer correlativo.
        ...
        self._view.frame.edit_comportamiento.setValue(comportamiento)
