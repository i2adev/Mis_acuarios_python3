...
class RequerimientoIluminacionDialogController(
    RequerimientoIluminacionController):
    ...
    def __init__(self,
        ...
        """
        Constructor base
        :param view: Cuadro de diálogo de inserción del requerimiento de
        iluminación.
        :param dao: DAO de comportamiento de la posición del requerimiento
        de iluminación.
        :param mod: Modelo de comportamiento de la posición del
    ...
    def dialog_accept(self):
        ...
        self._requerimiento_result = RequerimientoIluminacionEntity(
            id=res.value,
            num=None,
