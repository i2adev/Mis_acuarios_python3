...
Fecha:  15/03/2026
Comentarios:
    Controlador base del nivel de nado.
"""
...
from Services.Validators.nivel_nado_validator import NivelNadoValidator
from Views.Dialogs.nivel_nado_dialog import NivelNadoDialog
from Views.Masters.nivel_nado_view import NivelNadoView


class NivelNadoController(BaseController):
    """ Controlador base del formulario maestro de tipo de filtro. """

    def __init__(self,
                 view: NivelNadoDialog | NivelNadoView,
                 dao: NivelNadoDAO,
                 model: NivelNadoEntity):
        """
        Inicializa el controlador de nivel de nado.
        :param view: NivelNadoDialog | NivelNadoView
        :param dao: NivelNadoDAO
        :param model: NivelNadoEntity
        """

        # Atributos
        self._nivel_result = None

        # Llamaos al constructor de la superclase
        super().__init__(view, dao, model)

    def _entity_configuration(self) -> NivelNadoEntity:
    ...
    def _validate_view(self) -> Result:
        ...
        val = NivelNadoValidator.validate_nivel(
    ...
    def _get_nivel(self):
        """ Devuelve el nivel de nado resultante. """

        return self._nivel_result
