...
from Services.Validators.periodo_validator import PeriodoValidator
from Views.Dialogs.periodo_dialog import PeriodoDialog
from Views.Masters.periodo_view import PeriodoView


class PeriodoController(BaseController):
    """ 
    ...
    def __init__(self,
        ...
        :param view: PeriodoDialog | PeriodoView
        :param dao: PeriodoDAO
        :param model: PeriodoEntity
        """

        # Atributos
        self._periodo_result = None

        # Llamaos al constructor de la superclase
        super().__init__(view, dao, model)

    def _entity_configuration(self) -> PeriodoEntity:
    ...
    def _validate_view(self) -> Result:
        ...
        val = PeriodoValidator.validate_periodo(
    ...
    def _load_record(self) -> Result:
        ...
        periodo = modelo.index(fila, 2).data()

        # Cargamos los widgets
        self._view.frame.edit_id.setText(
            str(id_cat) if id_cat is not None else ""
        )
        self._view.frame.edit_periodo.setValue(periodo)
