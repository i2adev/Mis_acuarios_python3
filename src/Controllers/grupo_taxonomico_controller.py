...
Fecha:  16/03/2026
Comentarios:
    Controlador base del grupo taxonómico.
"""
...
class GrupoTaxonomicoController(BaseController):
    """ Controlador base del formulario maestro de grupo taxonómico. """

    def __init__(self,
                 view: GrupoTaxonomicoDialog | GrupoTaxonomicoView,
                 dao: GrupoTaxonomicoDAO,
                 model: GrupoTaxonomicoEntity):
        """
        Inicializa el controlador de comportamiento de fauna.
        :param view: GrupoTaxonomicoDialog | GrupoTaxonomicoView
        :param dao: GrupoTaxonomicoDAO
        :param model: GrupoTaxonomicoEntity
        """

        # Atributos
        self._grupo_result = None

        # Llamaos al constructor de la superclase
        super().__init__(view, dao, model)

    def _entity_configuration(self) -> GrupoTaxonomicoEntity:
        """ Configura la entidad. """

        ent = GrupoTaxonomicoEntity()
    ...
    def _validate_view(self) -> Result:
        ...
        val = GrupoTaxonomicoValidator.validate_grupo(
    ...
    def _get_grupo(self):
        """ Devuelve el grupo taxonómico resultante. """

        return self._grupo_result
    ...
    def _load_record(self) -> Result:
        ...
        grupo = modelo.index(fila, 2).data()  # La columna 1 es el
        # númer correlativo.
