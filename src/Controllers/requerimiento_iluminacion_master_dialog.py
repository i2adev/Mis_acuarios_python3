...
Fecha:  31/03/2026
Comentarios:
    Controlador del formulario maestro de la posición del requerimiento de 
    iluminación.
"""
...
import globals
from Controllers.requerimiento_iluminacion_controller import \
...
from Model.TableModel.requerimiento_iluminacion_table_model import \
    RequerimientoIluminacionTableModel
from Views.Masters.requerimiento_iluminacion_view import \
    RequerimientoIluminacionView
from Views.table_menu_contextual import TableMenuContextual


class RequerimientoIluminacionMasterController(
    RequerimientoIluminacionController):
    """
    Controlador del formulario maestro de la posición del requerimiento de 
    iluminación.
    ...
    def __init__(self, view: RequerimientoIluminacionView,
                 dao: RequerimientoIluminacionDAO,
                 mod: RequerimientoIluminacionEntity):
        """
        Constructor base
        :param view: Formulario maestro del requerimiento de iluminación.
        :param dao: DAO de comportamiento del requerimiento de iluminación.
        :param mod: Modelo de comportamiento del requerimiento de iluminación.
        """
        ...
        self._pag = Paginator("VISTA_REQUERIMIENTOS_ILUMINACION", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[RequerimientoIluminacionEntity]):
        """ Carga los datos en la tabla. """

        tv_model = RequerimientoIluminacionTableModel(data)
