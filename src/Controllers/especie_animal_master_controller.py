...
import globals
from Controllers.especie_animal_controller import EspecieAnimalController
...
from Model.TableModel.especie_animal_table_model import EspecieAnimalTableModel
