...
Fecha:      09/04/2026
Comentarios:
    Módulo que contiene el formulario maestro de especie vegetal.
"""
...
from ModuloMaestro.Views.Forms.especie_vegetal_form import EspecieVegetalForm
from ModuloMaestro.Views.Forms.image_form import ImageForm
from Main.Views.base_view import BaseView


class EspecieVegetalView(BaseView):
    """
    Formulario maestro de la ESPECIE VEGETAL.
    """
...
if __name__ == "__main__":
    ...
    ventana = EspecieVegetalView("...::OOO::....")
