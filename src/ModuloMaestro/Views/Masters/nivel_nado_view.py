...
Fecha:      15/03/2026
Comentarios:
    Módulo que contiene el formulario maestro del nivel de nado.
"""
...
from ModuloMaestro.Views.Forms.nivel_nado_form import NivelNadoForm
from Main.Views.base_view import BaseView


class NivelNadoView(BaseView):
    """
    Formulario maestro del NIVEL DE NADO.
    """
    ...
    def set_tab_order(self):
        ...
        # Establecer el orden
        self.setTabOrder(
            self.frame.edit_nivel, self.frame.text_descripcion
        )
