...
from ModuloMaestro.Views.Forms.proyecto_form import ProyectoForm
...
class ProyectoView(BaseView):
    ...
    def __init__(self, w_title: str):
        ...
        self.frame_image.setMinimumWidth(450)
    ...
    def set_tab_order(self):
        ...
        self.frame.date_inicio.edit_date.setFocusPolicy(
            Qt.FocusPolicy.StrongFocus)
        self.frame.date_fin.edit_date.setFocusPolicy(
            Qt.FocusPolicy.StrongFocus)
        self.frame.edit_motivo_cierre.setFocusPolicy(
            Qt.FocusPolicy.StrongFocus)
