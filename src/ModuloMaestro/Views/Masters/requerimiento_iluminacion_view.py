...
from ModuloMaestro.Views.Forms.requerimiento_ilumincacion_form import \
    RequerimientoIluminacionForm
from Main.Views.base_view import BaseView


class RequerimientoIluminacionView(BaseView):
    """
    Formulario maestro del REQUERIMIENTO DE ILUMINACIÓN.
    """
    ...
    def __init__(self, w_title: str):
        ...
        self.frame = RequerimientoIluminacionForm()
...
if __name__ == "__main__":
    ...
    ventana = RequerimientoIluminacionView("...::OOO::....")
