...
Fecha:      27/12/2025
Comentarios:
    Módulo que contiene el formulario maestro de iluminación.
"""
...
from ModuloMaestro.Views.Forms.iluminacion_form import IluminacionForm
from ModuloMaestro.Views.Forms.image_form import ImageForm
from Main.Views.base_view import BaseView


class IluminacionView(BaseView):
    """
