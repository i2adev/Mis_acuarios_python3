...
Fecha:      11/12/2025
Comentarios:
    Módulo que contiene el formulario maestro de categoría de equipamiento.
"""
...
from ModuloMaestro.Views.Forms.categoria_equipamiento_form import CategoriaEquipamientoForm
from Main.Views.base_view import BaseView


class CategoriaEquipamientoView(BaseView):
    """
    Formulario maestro de la CATEGORÍA DE EQUIPAMIENTO.
    """
...
if __name__ == "__main__":
    ...
    ventana = CategoriaEquipamientoView("...::OOO::....")
