...
Fecha:      14/09/2026
Comentarios:
    Módulo que contiene el diálogo de la entidad TIPO DE CONTROL DE 
    TEMPERATURA.
"""
...
class TipoControlTemperaturaDialog(BaseDialog):
    """ Diálogo de tipo de control de temperatura """
...
if __name__ == "__main__":
    ...
    ventana = TipoControlTemperaturaDialog("...::OOO::....")
