...
Fecha:      18/12/2025
Comentarios:
    Módulo que contiene el diálogo de la entidad COMERCIO.
"""
...
from ModuloMaestro.Views.Forms.comercio_form import ComercioForm


class ComercioDialog(BaseDialog):
    ...
    def set_tab_order(self):
        ...
        self.frame.edit_comercio.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
        ...
        # Establecer el orden
        self.setTabOrder(self.frame.edit_comercio, self.frame.edit_direccion)
        self.setTabOrder(self.frame.edit_direccion, self.frame.edit_cod_postal)
        self.setTabOrder(self.frame.edit_cod_postal, self.frame.edit_poblacion)
        self.setTabOrder(self.frame.edit_poblacion, self.frame.edit_provincia)
        self.setTabOrder(self.frame.edit_provincia, self.frame.combo_pais)
        self.setTabOrder(self.frame.combo_pais, self.frame.text_observaciones)
