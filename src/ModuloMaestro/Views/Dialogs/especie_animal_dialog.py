...
Fecha:      23/03/2026
Comentarios:
    Módulo que contiene el diálogo de la entidad ESPECIE ANIMAL.
"""
...
from ModuloMaestro.Views.Forms.especie_animal_form import EspecieAnimalForm
from ModuloMaestro.Views.Forms.image_form import ImageForm


class EspecieAnimalDialog(BaseDialog):
...
if __name__ == "__main__":
    ...
    ventana = EspecieAnimalDialog("...::OOO::....")
