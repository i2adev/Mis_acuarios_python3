...
from ModuloMaestro.Model.DAO.fotografia_dao import FotografiaDAO
from ModuloMaestro.Model.Entities.fotografia_entity import FotografiaEntity
...
class ImageForm(QFrame):
    ...
    def create_widgets(self):
        ...
        self.label_num_total_imegenes.setAlignment(
