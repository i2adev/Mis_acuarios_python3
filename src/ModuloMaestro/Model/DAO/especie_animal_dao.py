...
class EspecieAnimalDAO(BaseDAO):
        ...
        try:
            ...
            with self.db.conn as con:
                ...
                ent = EspecieAnimalEntity(
                    ...
                    nombre_comun=row[9],
                    es_hibrida=row[10],
                    nombre_especie_hibrida=row[11],
                    id_grupo_taxonomico=row[12],
                    ph_min=row[13],
                    ph_max=row[14],
                    kh_min=row[15],
                    kh_max=row[16],
                    ...
                    origen=row[21],
                    tamano_cm=row[22],
                    id_comportamiento=row[23],
                    id_dieta=row[24],
                    id_nivel_nado=row[25],
                    descripcion=row[26],
                )
    ...
    def insert(self, ent: EspecieAnimalEntity) -> Result:
        ...
        params = {
            ...
            "n_e_hibridada": ent.nombre_especie_hibrida,
            "gr_taxo": ent.id_grupo_taxonomico,
            "origen": ent.origen,
            "ph_min": ent.ph_min,
            "ph_max": ent.ph_max,
            "kh_min": ent.kh_min,
