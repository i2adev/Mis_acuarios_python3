...
Fecha:      16/03/2026
Comentarios:
    DAO para la entidad GrupoTaxonomicoEntity.
"""
...
class GrupoTaxonomicoDAO(BaseDAO):
    """
    ...
    # ------------------------------------------------------------------
    def insert(self, ent: GrupoTaxonomicoEntity) -> Result:
        """Inserta un nuevo registro y devuelve el ID generado."""

        sql = (
            """
            INSERT INTO GRUPOS_TAXONOMICOS (GRUPO_TAXONOMICO, DESCRIPCION)
            VALUES (:grupo, :descripcion);
            """
        )
        params = {"grupo": ent.grupo_taxonomico,
    ...
    # ------------------------------------------------------------------
    def update(self, ent: GrupoTaxonomicoEntity) -> Result(int):
        """Actualiza un registro. Devuelve el ID de la entidad modificada."""

        sql = (
            """
            UPDATE  GRUPOS_TAXONOMICOS
            SET     GRUPO_TAXONOMICO = :grupo,
                    DESCRIPCION = :descripcion
            WHERE   ID_GRUPO_TAXONOMICO = :id;
            """
        )
        params = {"id": ent.id,
                  "grupo": ent.grupo_taxonomico,
                  "descripcion": ent.descripcion}
        try:
            with self.db.conn as con:
    ...
    def delete(self, id_: int) -> Result(int):
        ...
        sql = (
            """
            DELETE FROM GRUPOS_TAXONOMICOS
            WHERE ID_GRUPO_TAXONOMICO = :id;
            """
        )
        params = {"id": id_}
