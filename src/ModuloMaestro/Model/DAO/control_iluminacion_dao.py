...
class ControlIluminacionDAO(BaseDAO):
    """
    ...
    def get_entity_by_id(self, ide: int) -> Result:
        ...
        try:
            sql = (
                ...
                WHERE  ID_CONTROL_ILUMINACION = :id;
                """
            )
    ...
    def get_list(self) -> Result:
        """Obtiene el listado completo ordenado por tipo de control."""
    ...
    # ------------------------------------------------------------------
    def insert(self, ent: ControlIluminacionEntity) -> Result:
        """
        ...
        sql = (
            """
            INSERT INTO CONTROLES_ILUMINACION (TIPO_CONTROL, DESCRIPCION)
            VALUES (:control, :descripcion);
            """
        )
        params = {
    ...
    # ------------------------------------------------------------------
    def update(self, ent: ControlIluminacionEntity) -> Result(int):
        """
        ...
        sql = (
            """
            UPDATE  CONTROLES_ILUMINACION
            SET     TIPO_CONTROL = :control,
    ...
    def delete(self, id_: int) -> Result:
        ...
        sql = (
            """
            DELETE FROM CONTROLES_ILUMINACION
            WHERE ID_CONTROL_ILUMINACION = :id;
            """
        )
        params = {"id": id_}
