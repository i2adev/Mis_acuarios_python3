...
Fecha:      06/04/2026
Comentarios:
    DAO para la entidad PeriodoEntity.
"""
...
class PeriodoDAO(BaseDAO):
    ...
    # ------------------------------------------------------------------
    def insert(self, ent: PeriodoEntity) -> Result:
    ...
    # ------------------------------------------------------------------
    def update(self, ent: PeriodoEntity) -> Result(int):
