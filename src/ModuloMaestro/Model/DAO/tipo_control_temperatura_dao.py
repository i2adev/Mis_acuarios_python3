...
Comentarios:
    ...
    entidad TIPO DE CONTROL DE TEMPERATURA.
"""
import sqlite3
...
class TipoControlTemperaturaDAO(BaseDAO):
    """
    ...
    def get_entity_by_id(self, ide: int) -> Result:
        ...
        try:
            sql = (
                """
                SELECT  ID_TIPO_CONTROL_TEMPERATURA,
                        TIPO_CONTROL_TEMPERATURA, DESCRIPCION
                FROM    TIPOS_CONTROL_TEMPERATURA
                WHERE   ID_TIPO_CONTROL_TEMPERATURA = :id;
                """
            )
            ...
            with self.db.conn as con:
                ...
                ent = TipoControlTemperaturaEntity(
                    id=row[0],
                    tipo_control_temperatura=row[1],
                    descripcion=row[2],
                )
    ...
    def get_list_combo(self) -> Result:
        ...
        sql = (
            """
            SELECT    ID_TIPO_CONTROL_TEMPERATURA AS ID,
                      TIPO_CONTROL_TEMPERATURA AS VALUE
            FROM      TIPOS_CONTROL_TEMPERATURA
            ORDER BY  TIPO_CONTROL_TEMPERATURA;
            """
        )
    ...
    # ------------------------------------------------------------------
    def insert(self, ent: TipoControlTemperaturaEntity) -> Result:
        """
        ...
        params = {
            "tipo": ent.tipo_control_temperatura,
    ...
    # ------------------------------------------------------------------
    def update(self, ent: TipoControlTemperaturaEntity) -> Result:
        """
        ...
        sql = (
            """
            UPDATE  TIPOS_CONTROL_TEMPERATURA
            SET     ID_TIPO_CONTROL_TEMPERATURA = :id,
                    TIPO_CONTROL_TEMPERATURA = :tipo,
    ...
    def delete(self, id_: int) -> Result:
        ...
        sql = (
            """
            DELETE FROM TIPOS_CONTROL_TEMPERATURA
            WHERE ID_TIPO_CONTROL_TEMPERATURA = :id;
            """
        )
        params = {"id": id_}
