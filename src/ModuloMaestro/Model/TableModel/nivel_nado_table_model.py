...
Comentarios:
    ...
    NIVELES DE NADO. Este módulo se encarga de dar formato a los datos
    de la tabla.
"""
...
class NivelNadoTableModel(QAbstractTableModel):
    """
    Clase que controla la visualización de la lista de niveles de nado.
    """

    def __init__(self, data: list[NivelNadoEntity]):
        """ Constructor de la clase. """

        super().__init__()
        self.data = data
        self._headers = ["ID", "#", "NIVEL", "DESCRIPCIÓN"]
    ...
    def headerData(self, section, orientation,
        ...
        if role == Qt.ItemDataRole.ToolTipRole:
            tooltips = {
                0: """
                <h2>Identificador del nivel</h2>
                Este campo muestra el <b>ID</b> de la entidad 
                nivel de nado.
                """,
                1: """
                <h2>Número correlativo del nivel</h2>
                Este campo muestra el <b>número correlativo</b> del 
                nivel de nado.
                """,
                2: """
                <h2>Nivel</h2>
                Este campo muestra el <b>nivel</b> en el que nada el pez.
                """,
                3: """
                <h2>Descripción</h2>
                Este campo muestra la <b>descripción</b> del nivel de nado 
                de los peces.
                """,
            }
