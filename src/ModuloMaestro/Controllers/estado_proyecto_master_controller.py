...
from ModuloMaestro.Controllers.estado_proyecto_controller import \
    EstadoProyectoController
from ModuloMaestro.Model.DAO.estado_proyecto_dao import EstadoProyectoDAO
from ModuloMaestro.Model.TableModel.estado_proyecto_table_model import \
...
class EstadoProyectoMasterController(EstadoProyectoController):
    ...
    def __init__(self, view: EstadoProyectoView, dao: EstadoProyectoDAO,
                 mod: EstadoProyectoEntity):
        """
        Constructor base
        :param view: Formulario maestro del estado de proyecto
        ...
        self._pag = Paginator("VISTA_ESTADOS_PROYECTO", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[EstadoProyectoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = EstadoProyectoTableModel(data)
