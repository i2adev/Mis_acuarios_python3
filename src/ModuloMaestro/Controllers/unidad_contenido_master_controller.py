...
from ModuloMaestro.Controllers.unidad_contenido_controller import \
    UnidadContenidoController
...
from ModuloMaestro.Model.TableModel.unidad_contenido_table_model import \
...
class UnidadContenidoMasterController(UnidadContenidoController):
    """ Controlador del formulario maestro de unidad contenido. """

    def __init__(self, view: UnidadContenidoView,
                 dao: UnidadContenidoDAO,
                 mod: UnidadContenidoEntity):
        """
        Constructor base
        :param view: Formulario maestro de unidad contenido
        :param dao: DAO de unidad contenido
        :param mod: Modelo de unidad contenido
        """
        ...
        self._pag = Paginator("VISTA_UNIDAD_CONTENIDO", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[UnidadContenidoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = UnidadContenidoTableModel(data)
