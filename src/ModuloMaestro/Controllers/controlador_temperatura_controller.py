...
Fecha:  18/08/2026
Comentarios:
    Controlador base de controlador de temperatura.
"""
...
from ModuloMaestro.Controllers.tipo_control_temperatura_dialog_controller import \
    TipoControlTemperaturaDialogController
...
class ControladorTemperaturaController(BaseController):
    """ 
    Controlador base del cuadro de diálogo y formulario de controlador 
    de temperatura. 
    """

    def __init__(self,
                 view: ControladorTemperaturaDialog | ControladorTemperaturaView,
                 dao: ControladorTemperaturaDAO,
                 model: ControladorTemperaturaEntity):
        """
        Inicializa el controlador de controlador de temperatura.
        :param view: ControladorTemperaturaDialog | ControladorTemperaturaView
        :param dao: ControladorTemperaturaDAO
        :param model: ControladorTemperaturaEntity
        """

        # Atributos
        self._controlador_temperatura_result = None
    ...
    def _entity_configuration(self) -> ControladorTemperaturaEntity:
        ...
        ent.id_tipo_control_temperatura = ctrs.combo_tipo_controlador.value()
    ...
    def _validate_view(self) -> Result:
        ...
        res = ControladorTemperaturaValidator.validate_marca(
        ...
        # Valida el modelo
        res = ControladorTemperaturaValidator.validate_modelo(
        ...
        res = ControladorTemperaturaValidator.validate_numero_serie(
        ...
        res = ControladorTemperaturaValidator.validate_fecha_alta(
    ...
    def _get_controlador(self):
        """ Devuelve el controlador de temperatura resultante. """

        return self._controlador_temperatura_result
    ...
    def _fill_combos_async(self):
        ...
        self._load_combo(
            ...
            worker_fn=lambda: TipoControlTemperaturaDAO().get_list_combo()
        )
    ...
    def _open_tipo_control_temperatura_dialog(self):
        """ Abrimos el diálogo del tipo de filtro. """

        # Configuramos el CONTROLADOR
        view = TipoControlTemperaturaDialog("INSERTAR TIPO DE CONTROL DE "
                                            "TEMPERATURA")
        dao = ControladorTemperaturaDAO()
        mod = TipoControlTemperaturaEntity()

        ctrl = TipoControlTemperaturaDialogController(view, dao, mod)
    ...
    def _load_data(self) -> Result:
        ...
        self._view.frame.combo_tipo_controlador.setValue(
            ent.id_tipo_control_temperatura)
