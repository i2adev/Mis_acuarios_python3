...
from ModuloMaestro.Controllers.tipo_filtro_controller import \
    TipoFiltroController
from ModuloMaestro.Model.TableModel.tipo_filtro_table_model import \
    TipoFiltroTableModel
