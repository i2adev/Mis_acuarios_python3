...
from ModuloMaestro.Model.TableModel.comercio_table_model import \
    ComercioTableModel
...
class ComercioMasterController(ComercioController):
    ...
    def __init__(self, view: ComercioView, dao: ComercioDAO,
                 mod: ComercioEntity):
        """
        Constructor base
        :param view: Formulario maestro de comercio
        ...
        self._pag = Paginator("VISTA_COMERCIOS", 5)
    ...
    def _fill_tableview(self, table: QTableView,
        ...
        tv_model = ComercioTableModel(data)
