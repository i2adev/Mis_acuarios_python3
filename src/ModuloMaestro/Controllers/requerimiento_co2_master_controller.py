...
class RequerimientoCO2MasterController(RequerimientoCO2Controller):
    """
    Controlador del formulario maestro de la posición del requerimiento de CO2.
    """

    def __init__(self, view: RequerimientoCO2View,
                 dao: RequerimientoCO2DAO,
                 mod: RequerimientoCO2Entity):
        """
        Constructor base
        :param view: Formulario maestro del requerimiento de CO2.
        :param dao: DAO de comportamiento del requerimiento de CO2.
        :param mod: Modelo de comportamiento del requerimiento de CO2.
        """
        ...
        self._pag = Paginator("VISTA_REQUERIMIENTOS_CO2", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[RequerimientoCO2Entity]):
        """ Carga los datos en la tabla. """

        tv_model = RequerimientoCO2TableModel(data)
