...
from ModuloMaestro.Model.TableModel.tipo_iluminacion_table_model import \
...
class TipoIluminacionMasterController(TipoIluminacionController):
    ...
    def __init__(self, view: TipoIluminacionView, dao: TipoIluminacionDAO,
                 mod: TipoIluminacionEntity):
        """
        Constructor base
        :param view: Formulario maestro de tipo de iluminacion
        :param dao: DAO del tipo de iluminacion
        :param mod: Modelo del tipo de iluminacion
        """
        ...
        self._pag = Paginator("VISTA_TIPO_ILUMINACION", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[TipoIluminacionEntity]):
        """ Carga los datos en la tabla. """

        tv_model = TipoIluminacionTableModel(data)
