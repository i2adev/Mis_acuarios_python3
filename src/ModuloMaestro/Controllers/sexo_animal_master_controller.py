...
Fecha:  06/04/2026
Comentarios:
    Controlador del formulario maestro del sexo animal.
"""
...
class SexoAnimalMasterController(SexoAnimalController):
    """
    Controlador del formulario maestro del sexo del animal.
    """

    def __init__(self, view: SexoAnimalView,
                 dao: SexoAnimalDAO,
        ...
        self._pag = Paginator("VISTA_SEXO_ANIMAL", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[SexoAnimalEntity]):
        """ Carga los datos en la tabla. """

        tv_model = SexoAnimalTableModel(data)
