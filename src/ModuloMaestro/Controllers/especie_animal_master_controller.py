...
from ModuloMaestro.Model.Entities.especie_animal_entity import \
    EspecieAnimalEntity
from ModuloMaestro.Model.TableModel.especie_animal_table_model import \
    EspecieAnimalTableModel
...
class EspecieAnimalMasterController(EspecieAnimalController):
    """ Controlador del formulario maestro de especie animal. """

    def __init__(self, view: EspecieAnimalView,
                 dao: EspecieAnimalDAO,
                 mod: EspecieAnimalEntity):
        """
        Constructor base
        :param view: Formulario maestro de especie animal.
    ...
    def _fill_tableview(self, table: QTableView,
        ...
        tv_model = EspecieAnimalTableModel(data)
