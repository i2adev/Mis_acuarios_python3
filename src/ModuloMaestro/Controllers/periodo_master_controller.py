...
Fecha:  07/04/2026
Comentarios:
    Controlador del formulario maestro de la posición del periodo.
"""
...
class PeriodoMasterController(
    PeriodoController):
    """
    Controlador del formulario maestro de la posición del periodo.
    """

    def __init__(self, view: PeriodoView,
                 dao: PeriodoDAO,
                 mod: PeriodoEntity):
        """
        Constructor base
        :param view: Formulario maestro del periodo.
        :param dao: DAO de comportamiento del periodo.
        :param mod: Modelo de comportamiento del periodo.
        """
        ...
        self._pag = Paginator("VISTA_PERIODOS", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[PeriodoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = PeriodoTableModel(data)
