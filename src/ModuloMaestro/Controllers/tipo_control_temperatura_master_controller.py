...
Fecha:  16/09/2026
Comentarios:
    Controlador del formulario maestro de tipo de control de temperatura.
"""
...
from ModuloMaestro.Model.TableModel.tipo_control_temperatura_table_model import \
    TipoControlTemperaturaTableModel
...
class TipoControlTemperaturaMasterController(TipoControlTemperaturaController):
    """ Controlador del formulario maestro de tipo de control de 
    temperatura. """

    def __init__(self, view: TipoControlTemperaturaView,
                 dao: TipoControlTemperaturaDAO,
                 mod: TipoControlTemperaturaEntity):
        """
        Constructor base
        :param view: TipoControlTemperaturaView
        ...
        self._pag = Paginator("VISTA_TIPOS_CONTROL_TEMPERATURA", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[TipoControlTemperaturaEntity]):
        """ Carga los datos en la tabla. """

        tv_model = TipoControlTemperaturaTableModel(data)
