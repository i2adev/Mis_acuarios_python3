...
from ModuloMaestro.Model.TableModel.consumible_table_model import \
    ConsumibleTableModel
...
class ConsumibleMasterController(ConsumibleController):
    ...
    def __init__(self, view: ConsumibleView,
                 dao: ConsumibleDAO,
                 mod: ConsumibleEntity):
        """
        Constructor base
        :param view: Formulario maestro de consumible
        ...
        self._pag = Paginator("VISTA_CONSUMIBLES", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[ConsumibleEntity]):
        """ Carga los datos en la tabla. """

        tv_model = ConsumibleTableModel(data)
