...
from ModuloMaestro.Controllers.sexo_animal_controller import SexoAnimalController
...
from ModuloMaestro.Views.Dialogs.sexo_animal_dialog import SexoAnimalDialog
