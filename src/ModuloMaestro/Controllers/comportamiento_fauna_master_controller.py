...
from ModuloMaestro.Model.TableModel.comportamiento_fauna_table_model import \
    ComportamientoFaunaTableModel
...
class ComportamientoFaunaMasterController(ComportamientoFaunaController):
    ...
    def __init__(self, view: ComportamientoFaunaView,
                 dao: ComportamientoFaunaDAO,
                 mod: ComportamientoFaunaEntity):
        """
        Constructor base
        :param view: Formulario maestro de comportamiento de fauna
        ...
        self._pag = Paginator("VISTA_COMPORTAMIENTOS_FAUNA", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[ComportamientoFaunaEntity]):
        """ Carga los datos en la tabla. """

        tv_model = ComportamientoFaunaTableModel(data)
