...
from ModuloMaestro.Controllers.formato_consumible_controller import \
...
from ModuloMaestro.Model.TableModel.formato_consumible_table_model import \
    FormatoConsumibleTableModel
...
class FormatoConsumibleMasterController(FormatoConsumibleController):
    ...
    def __init__(self, view: FormatoConsumibleView,
                 dao: FormatoConsumibleDAO,
                 mod: FormatoConsumibleEntity):
        """
        Constructor base
        :param view: Formulario maestro del formato de consumible
        ...
        self._pag = Paginator("VISTA_FORMATOS_CONSUMIBLE", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[FormatoConsumibleEntity]):
        """ Carga los datos en la tabla. """

        tv_model = FormatoConsumibleTableModel(data)
