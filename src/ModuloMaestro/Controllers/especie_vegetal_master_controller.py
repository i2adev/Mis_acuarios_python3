...
Fecha:  24/03/2026
Comentarios:
    Controlador del formulario maestro de la especie animal.
"""
...
from ModuloMaestro.Model.TableModel.especie_vegetal_table_model import \
    EspecieVegetalTableModel
...
class EspecieVegetalMasterController(EspecieVegetalController):
    """ Controlador del formulario maestro de especie vegetal. """

    def __init__(self, view: EspecieVegetalView,
                 dao: EspecieVegetalDAO,
                 mod: EspecieVegetalEntity):
        """
        Constructor base
        :param view: Formulario maestro de especie vegetal.
    ...
    def button_filter_clicked(self):
        ...
        if self._pag.status == "FILTERED":
            ...
            self._clean_view(self._view.frame.edit_reino)
    ...
    def button_search_clicked(self):
        ...
        # Obtiene los datos
        self._pag.get_filtered_list(pattern, user)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[EspecieVegetalEntity]):
        """ Carga los datos en la tabla. """

        tv_model = EspecieVegetalTableModel(data)
