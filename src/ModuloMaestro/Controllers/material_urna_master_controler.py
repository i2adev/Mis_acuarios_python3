...
from ModuloMaestro.Controllers.material_urna_controller import \
    MaterialUrnaController
...
from ModuloMaestro.Model.Entities.material_urna_entity import \
    MaterialUrnaEntity
from ModuloMaestro.Model.TableModel.material_urna_table_model import \
    MaterialUrnaTableModel
...
class MaterialUrnaMasterController(MaterialUrnaController):
    ...
    def __init__(self, view: MaterialUrnaView, dao: MaterialUrnaDAO,
        ...
        """
        Constructor base
        :param view: Formulario maestro de material de urna
        :param dao: DAO de material de urna
        :param mod: Modelo de material de urna
        """
