...
from ModuloMaestro.Model.TableModel.nivel_nado_table_model import \
    NivelNadoTableModel
...
class NivelNadoMasterController(NivelNadoController):
    ...
    def __init__(self, view: NivelNadoView,
                 dao: NivelNadoDAO,
                 mod: NivelNadoEntity):
        """
        Constructor base
        :param view: Formulario maestro de nivel de nado
        ...
        self._pag = Paginator("VISTA_NIVELES_NADO", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[NivelNadoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = NivelNadoTableModel(data)
