...
from ModuloMaestro.Controllers.filtro_controller import FiltroController
from CustomControls.nullable_date_edit import NullableDateEdit
from ModuloMaestro.Model.DAO.filtro_dao import FiltroDAO
from ModuloMaestro.Model.TableModel.filtro_table_model import FiltroTableModel
...
class FiltroMasterController(FiltroController):
    """ Controlador del formulario maestro de filtro. """

    def __init__(self, view: FiltroView,
                 dao: FiltroDAO,
                 mod: FiltroEntity):
        """
        Constructor base.
        :param view: Formulario maestro de filtro
        ...
        self._pag = Paginator("VISTA_FILTROS", 5)
    ...
    def _fill_tableview(self, table: QTableView,
        ...
        tv_model = FiltroTableModel(data)
