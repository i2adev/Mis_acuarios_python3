...
from ModuloMaestro.Model.TableModel.categoria_consumible_table_model import \
...
class CategoriaConsumibleMasterController(CategoriaConsumibleController):
    ...
    def __init__(self, view: CategoriaConsumibleView,
                 dao: CategoriaConsumibleDAO,
                 mod: CategoriaConsumibleEntity):
        """
        Constructor base
        :param view: Formulario maestro de la categoría de consumible
        :param dao: DAO de la categoria de consumible
        :param mod: Modelo de la categoria de consumible
        """
        ...
        self._pag = Paginator("VISTA_CATEGORIAS_CONSUMIBLE", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[CategoriaConsumibleEntity]):
        """ Carga los datos en la tabla. """

        tv_model = CategoriaConsumibleTableModel(data)
