...
Fecha:  18/09/202
Comentarios:
    Controlador del formulario maestro de la categoría de controlador de temperatura.
"""
...
from ModuloMaestro.Model.TableModel.controlador_temperatura_table_model import \
    ControladorTemperaturaTableModel
...
class ControladorTemperaturaMasterController(ControladorTemperaturaController):
    """ Controlador del formulario maestro de filtro. """

    def __init__(self, view: ControladorTemperaturaView,
                 dao: ControladorTemperaturaDAO,
                 mod: ControladorTemperaturaEntity):
        """
        Constructor base.
        :param view: Formulario maestro de la categoría de controlador de temperatura.
        ...
        self._pag = Paginator("VISTA_CONTROLADORES_TEMPERATURA", 5)
    ...
    def _fill_tableview(self, table: QTableView,
        ...
        tv_model = ControladorTemperaturaTableModel(data)
