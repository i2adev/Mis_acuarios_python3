...
from ModuloMaestro.Controllers.grupo_taxonomico_controller import \
    GrupoTaxonomicoController
...
from ModuloMaestro.Model.TableModel.grupo_taxonomico_table_model import \
    GrupoTaxonomicoTableModel
...
class GrupoTaxonomicoMasterController(GrupoTaxonomicoController):
    """ Controlador del formulario maestro de grupo taxonómico. """

    def __init__(self, view: GrupoTaxonomicoView,
                 dao: GrupoTaxonomicoDAO,
                 mod: GrupoTaxonomicoEntity):
        """
        Constructor base
        :param view: Formulario maestro de grupo taxonómico.
        ...
        self._pag = Paginator("VISTA_GRUPOS_TAXONOMICOS", 5)
    ...
    def button_filter_clicked(self):
        ...
        if self._pag.status == "FILTERED":
            ...
            self._clean_view(self._view.frame.edit_grupo)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[GrupoTaxonomicoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = GrupoTaxonomicoTableModel(data)
