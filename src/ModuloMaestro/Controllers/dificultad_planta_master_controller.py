...
from ModuloMaestro.Controllers.dificultad_planta_controller import \
    DificultadPlantaController
...
from ModuloMaestro.Model.TableModel.dificultad_planta_table_model import \
