...
Fecha:  11/04/2026
Comentarios:
    Controlador del formulario maestro de la posición de la tasa de
    crecimiento.
"""
...
from ModuloMaestro.Controllers.tasa_crecimiento_controller import \
    TasaCrecimientoController
...
from ModuloMaestro.Model.TableModel.tasa_crecimiento_table_model import \
    TasaCrecimientoTableModel
...
class TasaCrecimientoMasterController(TasaCrecimientoController):
    """
    Controlador del formulario maestro de la posición de la tasa de 
    crecimiento.
    """

    def __init__(self, view: TasaCrecimientoView,
                 dao: TasaCrecimientoDAO,
                 mod: TasaCrecimientoEntity):
        """
        Constructor base
        :param view: Formulario maestro de la tasa de crecimiento.
        ...
        self._pag = Paginator("VISTA_TASAS_CRECIMIENTO", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[TasaCrecimientoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = TasaCrecimientoTableModel(data)
