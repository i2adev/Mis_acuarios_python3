...
from ModuloMaestro.Model.TableModel.tipo_equipamiento_table_model import \
    TipoEquipamientoTableModel
...
class CategoriaEquipamientoMasterController(CategoriaEquipamientoController):
    """ 
    Controlador del formulario maestro de categoría de equipamiento. 
    """

    def __init__(self, view: CategoriaEquipamientoView,
                 dao: CategoriaEquipamientoDAO,
                 mod: CategoriaEquipamientoEntity):
        """
        Constructor base
        :param view: Formulario maestro de categoría de equipamiento.
        ...
        self._pag = Paginator("VISTA_CATEGORIAS_EQUIPAMIENTO", 5)
    ...
    def _fill_tableview(self, table: QTableView,
                        data: list[CategoriaEquipamientoEntity]):
        """ Carga los datos en la tabla. """

        tv_model = TipoEquipamientoTableModel(data)
