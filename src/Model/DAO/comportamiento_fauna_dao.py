...
class ComportamientoFaunaDAO(BaseDAO):
    """
    ...
    def get_list(self) -> Result:
        """Obtiene el listado completo ordenado por comportamiento."""
    ...
    def get_num_by_id(self, id_: int) -> Result:
        ...
        sql = (
            """
            SELECT NUM
            FROM   VISTA_COMPORTAMIENTOS_FAUNA
            WHERE  ID = :id;
            """
        )
        params = {"id": id_}
    ...
    # ------------------------------------------------------------------
    def insert(self, ent: ComportamientoFaunaEntity) -> Result:
        """Inserta un nuevo registro y devuelve el ID generado."""

        sql = (
            """
            INSERT INTO COMPORTAMIENTOS_FAUNA (COMPORTAMIENTO, DESCRIPCION)
            VALUES (:comportamiento, :descripcion);
            """
        )
        params = {"comportamiento": ent.comportamiento,
    ...
    # ------------------------------------------------------------------
    def update(self, ent: ComportamientoFaunaEntity) -> Result(int):
        """Actualiza un registro. Devuelve el ID de la entidad modificada."""

        sql = (
            """
            UPDATE  COMPORTAMIENTOS_FAUNA
        ...
        params = {"id": ent.id,
                  "comportamiento": ent.comportamiento,
                  "descripcion": ent.descripcion}
        try:
            with self.db.conn as con:
    ...
    def delete(self, id_: int) -> Result(int):
        ...
        sql = (
            """
            DELETE FROM COMPORTAMIENTOS_FAUNA
            WHERE ID_COMPORTAMIENTO = :id;
            """
        )
        params = {"id": id_}
