...
Fecha:      30/03/2026
Comentarios:
    DAO para la entidad RequerimientoCO2Entity.
"""
...
class RequerimientoCO2DAO(BaseDAO):
    """
    ...
    # ------------------------------------------------------------------
    def insert(self, ent: RequerimientoCO2Entity) -> Result:
        """ Inserta un nuevo registro y devuelve el ID generado. """

        sql = (
            """
            INSERT INTO REQUERIMIENTOS_CO2 (REQUERIMIENTO_CO2, DESCRIPCION)
    ...
    # ------------------------------------------------------------------
    def update(self, ent: RequerimientoCO2Entity) -> Result(int):
        """Actualiza un registro. Devuelve el ID de la entidad modificada."""

        sql = (
            """
            UPDATE  REQUERIMIENTOS_CO2
            SET     REQUERIMIENTO_CO2 = :requerimiento,
    ...
    def delete(self, id_: int) -> Result(int):
        ...
        sql = (
            """
            DELETE FROM REQUERIMIENTOS_CO2
            WHERE ID_REQUERIMIENTO_CO2 = :id;
            """
        )
        params = {"id": id_}
