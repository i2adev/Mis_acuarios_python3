...
from Main.Controllers.usuario_controller import UsuarioDialogController
...
from ModuloMaestro.Views.Dialogs.usuario_dialog import UsuarioDialog
...
class LoginDialogController(BaseController):
    ...
    def get_user_by_nick(self, nick: str) -> Result:
    ...
    def button_entrar_click(self):
        ...
        if not res.is_success:
            ...
            return
        globales.CURRENT_USER = res.value
        self._view.accept()
