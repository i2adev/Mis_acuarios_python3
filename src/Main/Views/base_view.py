...
class BaseView(QWidget):
    ...
    def create_widgets(self):
        ...
        icon5 = QPixmap(str(Path(globales.PATH_IMAGES) / "Window_icon.png"))
        ...
        icon_filter.addPixmap(
            QPixmap(str(Path(globales.PATH_IMAGES) / "filter.png")),
            QIcon.Mode.Normal,
            QIcon.State.On)
        ...
        icon_search.addPixmap(
            QPixmap(str(Path(globales.PATH_IMAGES) / "search.png")),
            QIcon.Mode.Normal,
            QIcon.State.On)
...
if __name__ == "__main__":
    ...
    with open(str(Path(globales.PATH_STYLES) / "main_style.qss"), "r",
