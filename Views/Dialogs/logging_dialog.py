...
class LoginDianlog(QDialog):
    ...
    def build_layout(self):
        ...
        self.layout_form_data.addWidget(self.label_mail)
        self.layout_form_data.addWidget(self.edit_mail)
...
if __name__ == "__main__":
    ...
    ventana = LoginDianlog("BASE DIALOG")
